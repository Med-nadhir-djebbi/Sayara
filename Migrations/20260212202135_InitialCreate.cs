        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CylinderCapacity = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: false),
                    Color = table.Column<string>(type: "TEXT", nullable: false),
                    Description = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Discriminator = table.Column<string>(type: "TEXT", maxLength: 13, nullable: false),
                    DailyRate = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: true),
                    WeeklyRate = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: true),
                    MonthlyRate = table.Column<decimal>(type: "TEXT", precision: 10, scale: 2, nullable: true),
